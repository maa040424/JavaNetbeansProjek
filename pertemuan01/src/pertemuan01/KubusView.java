...
public class KubusView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Input Nilai Sisi :");

        jLabel3.setText("Hasil Volume :");

        jLabel4.setText("Hasil Luas Permukaan : ");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
         Kubus k = new Kubus();
        k.setSisi(Double.parseDouble(textS.getText()));
        textV.setText(k.getVolume() + " cm3");
        textL.setText(k.getLuasPermukaan() + " cm2");   
